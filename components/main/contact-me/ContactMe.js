...
const ContactMe = () => {
  ...
  return (
    <div id='contact' className='snap-start w-full min-h-screen flex flex-col gap-4 items-center justify-center bg-indigo-100 pt-8 px-6 md:pt-0'>
      <div className='flex flex-col gap-4 w-[95%] lg:w-[80%] bg-indigo-200/30 shadow-md rounded-md px-2 py-4 md:p-4'>
        <h1 className='border-r-8 pr-2 border-r-gray-400 text-2xl font-extrabold text-gray-600'>تماس با من</h1>
        <div className='bg-indigo-300/30 w-full flex flex-col md:flex-row md:items-start rounded-md shadow-md'>
          <FormContact />
